...
const ContactForm = () => {
    ...
    return (
        <form onSubmit={HandleFormSubmit} className="Fade_Up bg-LinkBtnGradient rounded-md w-full lg:max-w-[650px] px-4 py-2 outline outline-1 outline-white/20 flex_center flex-col" suppressHydrationWarning>
            <label
                htmlFor="name"
